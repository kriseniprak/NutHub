// Mapping tables ported from Network UPS Tools, drivers/idowell-hid.c (iDowell HID 0.23),
...
internal sealed partial class IDowellSubdriver
{
    /// <summary>The NUT subdriver this one is ported from, reported as driver.version.data.</summary>
    public override string Version => "iDowell HID 0.23";

    /// <summary>Vendor-specific usage names (NUT idowell_usage_lkp).</summary>
    private static readonly HidUsageTable VendorUsageTable = HidUsageTable.Empty;

    /// <summary>The USB ids this subdriver supports (NUT idowell_usb_device_table).</summary>
    ...
    private HidMapping[] BuildMappings()
    {
        ...
        [
            ...
            new("device.mfr", 0, "UPS.PowerSummary.iManufacturer", "%s", Static, CommonLookups.StringidConversion),
            new("device.model", 0, "UPS.PowerSummary.iProduct", "%s", Static, CommonLookups.StringidConversion),
            new("device.serial", 0, "UPS.PowerSummary.iSerialNumber", "%s", Static, CommonLookups.StringidConversion),
            new("battery.capacity.design", 0, "UPS.PowerSummary.DesignCapacity", "%.0f", Static, null),
            ...
            new("battery.charge.low", 0, "UPS.PowerSummary.WarningCapacityLimit", "%.0f", Static, null),
            new("battery.capacity.full", 0, "UPS.PowerSummary.FullChargeCapacity", "%.0f", None, null),
            ...
            new("output.voltage.nominal", 0, "UPS.Flow.[4].ConfigVoltage", "%.0f", Static, null),
